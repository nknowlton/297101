---
title: "297.101 Week 10: Relationships"
...
format: 
  revealjs:
    ...
    theme: sky
    css: ["part_c.css", "regression-lab.css"]
    slide-number: true
    incremental: false
    ...
    include-in-header:
      - text: |
         <style>
          ...
          .reveal .history-slide p {
             font-size: 0.72em !important;
             line-height: 1.3;
             margin: 0.45em 0;
          }

          .reveal .math-model-slide p {
             font-size: 0.72em !important;
             line-height: 1.3;
          }

          .reveal .math-model-slide .math.display {
...
//| echo: false
//| output: false
import { coefficientLab, regressionLab } from "./regression-lab.js"
```
...
## Two centuries of history {.history-slide}
...
# Moroccan donkeys {style="text-align: center;"}

![](https://upload.wikimedia.org/wikipedia/commons/6/66/Donkeys_of_Morocco.JPG){fig-align="center" width="82%"}

::: {.tiny style="text-align: center;"}
Photo: Makary / Wikimedia Commons, CC BY 3.0
:::
...
Adjust the coefficients and watch how the intercept and one-unit change in
the predicted mean update.
:::
...
## A mathematical formulation of the linear model {.math-model-slide}
...
:::{.columns}
:::{.column width="50%"}
![](https://images.pexels.com/photos/30298392/pexels-photo-30298392.jpeg){fig-align="center" width="96%"}
:::

:::{.column width="50%"}
![](https://commons.wikimedia.org/wiki/Special:Redirect/file/Fes,_Morocco_(28148932782).jpg){fig-align="center" width="82%"}
:::
:::

::: {.tiny style="text-align: center;"}
Photos: Othmane Ettalbi / Pexels; UC Berkeley Department of Geography / Wikimedia Commons
:::
