...
![](./graphics/donkey_morocco.jpg){fig-align="center" width="82%"}
...
## Add a regression line with `geom_abline()`
...
:::{.columns}
:::{.column width="50%"}
![](./graphics/donkey_pexels.jpg){fig-align="center" width="96%"}
:::

:::{.column width="50%"}
![](./graphics/donkey_fes.jpg){fig-align="center" width="82%"}
:::
:::
