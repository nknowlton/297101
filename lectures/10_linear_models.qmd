...
![](./graphics/donkey.png "Moroccan Donkey")
...
::: {.regression-instructions .small}
Adjust the proposed line, or click/drag directly on the MSE grid — each grid
point is a possible line (intercept × slope). 
:::
...
![](./graphics/donkey.png){fig-align="center"}
